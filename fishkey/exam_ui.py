...
# Form implementation generated from reading ui file 'qt_designs\exam.ui'
#
...
class Ui_SesionWindow(object):
    def setupUi(self, SesionWindow):
        ...
        self.timeRemaining_label = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(35)
        self.timeRemaining_label.setFont(font)
        self.timeRemaining_label.setAlignment(QtCore.Qt.AlignCenter)
        self.timeRemaining_label.setObjectName("timeRemaining_label")
        self.verticalLayout.addWidget(self.timeRemaining_label)
    ...
    def retranslateUi(self, SesionWindow):
        ...
        SesionWindow.setWindowTitle(_translate("SesionWindow", "Egzamin"))
        ...
        self.cardsLeftLabel.setText(_translate("SesionWindow", "Wykonano:"))
        self.cardsLeftCounter.setText(_translate("SesionWindow", "0/1"))
        self.timeRemaining_label.setText(_translate("SesionWindow", "00:00"))
